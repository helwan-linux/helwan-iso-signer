...
Features: English UI, Output dir selector, SHA512, Global Progress Bar, and Verify tab.
"""
import sys
import os
import subprocess
...
class SignerApp(QMainWindow):
    def __init__(self):
        ...
        # Icon setup (Assumes 'signer_icon.png' is in the same directory)
    ...
    def init_sign_tab(self):
        ...
        # 3. Hash Options Group (Includes SHA512)
        ...
        hash_layout.addWidget(self.hash_sha1, 0, 2)
        hash_layout.addWidget(self.hash_md5, 0, 3)
